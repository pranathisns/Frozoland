...
void readStockFromFile()
{
    ...
    if (stockFile != NULL) {
        fscanf(stockFile, "strawberrystock:%d blueberrystock:%d vanillastock:%d chocolatestock:%d\n", &strawberrystock, &blueberrystock, &vanillastock, &chocolatestock);
        fscanf(stockFile, "applestock:%lf Blueberrystock:%lf Strawberrystock:%lf Mangostock:%lf\n", &applestock, &Blueberrystock, &Strawberrystock, &Mangostock);
        fscanf(stockFile, "chocolatesaucestock:%lf sprinklesstock:%lf caramelsaucestock:%lf whippedcreamstock:%lf\n", &chocolatesaucestock, &sprinklesstock, &caramelsaucestock, &whippedcreamstock);
        fclose(stockFile);
    } else {
